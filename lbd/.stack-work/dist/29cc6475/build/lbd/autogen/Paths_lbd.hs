...
getLibDir = catchIO (getEnv "lbd_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "lbd_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "lbd_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "lbd_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "lbd_sysconfdir") (\_ -> return sysconfdir)
